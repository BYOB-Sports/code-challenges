...
// Create amenity filter checkboxes
...
function applyFilters(){
  ...
  filtered = COURTS.filter(c => {
    const hay = (c.name + ' ' + c.city + ' ' + c.amenities.join(' ')).toLowerCase();
    const matchesTerm = hay.includes(term);
...
// incremental rendering (scales to many courts)
function renderMore(){
